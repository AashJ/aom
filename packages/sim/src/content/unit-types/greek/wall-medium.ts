...
import { TYPE_GREEK_VILLAGER, TYPE_GREEK_WALL_MEDIUM } from "../../unit-type-ids";
...
export const definition = {
  id: TYPE_GREEK_WALL_MEDIUM, key: "greek-wall-medium", label: "Medium Wall",
  ...
  trainedAt: NO_TYPE_RELATIONSHIPS, builtBy: [{ type: TYPE_GREEK_VILLAGER, commandSlot: 17 }],
