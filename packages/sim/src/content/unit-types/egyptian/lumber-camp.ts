...
import { TYPE_EGYPTIAN_LABORER, TYPE_EGYPTIAN_LUMBER_CAMP } from "../../unit-type-ids";
import {
  CULTURE_EGYPTIAN,
...
export const definition = {
  id: TYPE_EGYPTIAN_LUMBER_CAMP,
  key: "egyptian-lumber-camp",
  label: "Lumber Camp",
