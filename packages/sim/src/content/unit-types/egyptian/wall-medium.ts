...
import { TYPE_EGYPTIAN_LABORER, TYPE_EGYPTIAN_WALL_MEDIUM } from "../../unit-type-ids";
...
export const definition = {
  id: TYPE_EGYPTIAN_WALL_MEDIUM, key: "egyptian-wall-medium", label: "Medium Wall",
  ...
  bodyRadius: 3, collidesWithProjectiles: true, footprint: 3, footprintDepth: 1,
  costFood: 0, costWood: 0, costGold: 6, costFavor: 0, buildTicks: 9 * 20,
  ...
  trainedAt: NO_TYPE_RELATIONSHIPS, builtBy: [{ type: TYPE_EGYPTIAN_LABORER, commandSlot: 23 }],
