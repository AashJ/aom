...
import { TYPE_EGYPTIAN_LABORER, TYPE_EGYPTIAN_MINING_CAMP } from "../../unit-type-ids";
import {
  CULTURE_EGYPTIAN,
  GOLD,
...
export const definition = {
  id: TYPE_EGYPTIAN_MINING_CAMP,
  key: "egyptian-mining-camp",
  label: "Mining Camp",
