...
export const definition = {
  id: TYPE_EGYPTIAN_GATE, key: "egyptian-gate", label: "Gate", culture: CULTURE_EGYPTIAN,
  classes: UNIT_CLASS_BUILDING, maxHp: 500, lineOfSight: 5, movementSpeed: 0,
  armor: [0.65, 0.96, 0.05], attack: null, isStatic: true, resource: -1,
  bodyRadius: 5, collidesWithProjectiles: true, footprint: 5, footprintDepth: 1,
  gateOpenRange: 3,
  costFood: 0, costWood: 0, costGold: 15, costFavor: 0, buildTicks: 10 * 20,
  ...
  trainedAt: NO_TYPE_RELATIONSHIPS, builtBy: [{ type: TYPE_EGYPTIAN_LABORER, commandSlot: 25 }],
